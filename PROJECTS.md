# Student Projects — BIFX 546: Machine Learning for Bioinformatics
...
Hood College | Department of Computer Science | Spring 2026
...
stromal cell populations shift across the lifespan — with implications for why
older patients respond differently to treatment.
...
and behavioral risk factors. The goal is a model that not only predicts diabetes
status but explains which indicators drive the risk — with practical implications
...
The workflow covers data cleaning, exploratory analysis, and visualization —
building toward an interpretable pipeline that could support remote, non-invasive
disease monitoring.
...
structured pipeline that preserves full trial context for downstream deep learning
models. The goal is to systematically surface overlooked molecules that may be
candidates for repurposing — potentially accelerating drug discovery efforts.
...
examining trends across eight age demographics, the project aims to uncover
age-specific patterns in disease burden — with potential value for public health
